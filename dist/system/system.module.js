...
exports.SystemModule = SystemModule = __decorate([
    (0, common_1.Module)({
        imports: [typeorm_1.TypeOrmModule.forFeature([AuditLog_entity_1.AuditLog, Run_entity_1.Run])],
        controllers: [system_controller_1.SystemController, audit_controller_1.AuditController],
